...
function SongCard({song}) {
  ...
  return (
    <div className='mx-3'>
      <div className='flex flex-col justify-between items-center gap-3 mt-7 rounded-lg bg-black bg-opacity-60 text-gray-800 w-[305px] h-[450px] md:w-[250px] md:h-[410px] cursor-pointer hover:scale-105 transition-transform duration-300 p-1'>
        ...
        {/* <div className="w-full">
          <audio controls className="w-full h-9 md:h-10 p-1.5">
