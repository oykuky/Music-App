      ...
      <div className='flex flex-col justify-between gap-1 mt-7 rounded-lg bg-black bg-opacity-60 text-gray-800 w-[315px] h-[470px] md:w-[250px] md:h-[425px] cursor-pointer hover:scale-105 hover:shadow-2xl transition-transform duration-300'>
          ...
          <div className='flex justify-between px-1.5 mb-3 mt-1'>
            <div onClick={handleFavoriteClick} className={`${isFavorite ? 'bg-yellow-400' : 'bg-black'} rounded-full cursor-pointer items-center flex justify-center mt-1 ml-1 hover:bg-yellow-400 transition-colors duration-300 w-10 h-10`}>
              <MdFavoriteBorder className="h-5 w-5 md:h-8 md:w-8 p-1"/>
            </div>
          ...
          <div className='justify-center flex ml-auto mr-2 mb-2 items-center h-10 w-10 rounded-lg cursor-pointer hover:bg-black transition-colors duration-300'>
